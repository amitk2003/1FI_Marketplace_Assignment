...
export const PortfolioLimitBanner: React.FC<Props> = ({ onOpenPortfolioModal, isMobileDeviceMode = false }) => {
  return (
    <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#6C28D9] via-[#7E22CE] to-[#A203D5] text-white p-4 sm:p-6 lg:p-8 shadow-brand-lg mb-6 sm:mb-8">
      ...
      <div className={isMobileDeviceMode ? "relative z-10 flex flex-col gap-6 items-stretch" : "relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-center"}>
        {/* Left column: Value Proposition */}
        <div className={isMobileDeviceMode ? "space-y-3" : "lg:col-span-7 space-y-3 sm:space-y-4"}>
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white/15 backdrop-blur-md rounded-full border border-white/20 text-[11px] sm:text-xs font-semibold text-purple-100">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2.5 pt-1">
            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/10 backdrop-blur-sm rounded-lg text-xs font-medium border border-white/10">
              <Zap className="w-3.5 h-3.5 text-yellow-300" />
              <span>Instant Approval</span>
            </div>
            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/10 backdrop-blur-sm rounded-lg text-xs font-medium border border-white/10">
              <TrendingUp className="w-3.5 h-3.5 text-emerald-300" />
              <span>Funds Keep Growing</span>
            </div>
            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/10 backdrop-blur-sm rounded-lg text-xs font-medium border border-white/10">
        ...
        <div className={isMobileDeviceMode ? "w-full" : "lg:col-span-5"}>
